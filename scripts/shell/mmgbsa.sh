...
if [[ -f "$mmgbsa/mmgbsa.do" && -f "$mmgbsa/mmgbsa.eo" && -f "$mmgbsa/mmgbsa.deo" ]]; then
  echo "Found existing MMGBSA raw outputs:"
  echo "  $mmgbsa/mmgbsa.do"
  echo "  $mmgbsa/mmgbsa.eo"
  echo "  $mmgbsa/mmgbsa.deo"
  echo "Skipping MMPBSA.py.MPI calculation."
else
